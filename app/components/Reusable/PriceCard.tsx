...
export default function PriceCard({
  ...
  return (
    <div className="bg-grey rounded-20 p-4 lg:p-8 border border-primary/15 w-full flex flex-col gap-4 lg:gap-8 justify-between">
      <div className=" flex gap-8 justify-between">
        ...
        <h1 className="text-4xl md:text-5xl lg:text-56 font-poppins leading-120 text-primary ">
          {price}
        </h1>
      </div>
