  ...
  return (
    <section className="max-w-7xl mx-auto px-4 lg:px-6 2xl:px-0 py-10 lg:py-28 flex flex-col gap-4 items-center">
      ...
      <div className="grid lg:grid-cols-2 gap-3 lg:gap-5 pt-6 md:pt-10 lg:pt-16">
        ...
        <div className="flex flex-col rounded-20 bg-grey border border-primary/15 overflow-hidden lg:row-span-2">
          <CardData
        ...
        <div className="grid sm:grid-cols-2 gap-3 lg:gap-5">
          <div className="bg-grey rounded-20 border border-primary/15 overflow-hidden flex flex-col justify-center gap-2 p-3 lg:p-6">
            {art_track}
            <h5 className="font-poppins text-primary text-xl lg:text-2xl">
              Fair and transparent player development system
            </h5>
            <p className="font-space-grotesk leading-150 text-primary">Track</p>
          </div>
          <div className="bg-grey rounded-20 border border-primary/15 overflow-hidden flex flex-col justify-center gap-2 p-3 lg:p-6 lg:pb-11">
            {user_identity}
            <h5 className="font-poppins text-primary text-xl lg:text-2xl">
              Scalable solution
            </h5>
